<template>
  <div id="CreateCarpoolPage" style="background-color: #fad3a5; display: flex; flex-direction: column; height: 150vh;">
    ...
    <div class="content-box" style="align-items:center; height:200px;">
      <div class="button-container" style="display: flex; align-items: left;">
        ...
        <label for="qrUpload" class="custom-file-upload button-style" style="margin-left:10px; margin-bottom:30px; ">
          Upload QR
        </label>
