  ...
  <div id="SignUpPage" style="background-color:  #fad3a5; display: flex; flex-direction: column; height: 150vh;">
    ...
    <div class="content-box">
      <div>
        ...
        <input type="date" v-model="date" required style="margin-bottom: 10px; border-radius: 10px; border-color: rgba(255, 255, 255, 0.5); text-align:center; width:200px; height: 30px; margin-left: 190px; background-color: #FBAF56;">
      </div>
      <div>
        <label style="font-weight:bold;">Start Location:</label>
        <input type="text" v-model="startLocation" required style="margin-bottom: 10px; border-radius: 10px; border-color: rgba(255, 255, 255, 0.5); text-align:center; width:200px; height: 30px; margin-left: 120px; background-color: #FBAF56;">
      </div>
      <div>
        <label style="font-weight:bold;">End Location:</label>
        <input type="text" v-model="endLocation" required style="margin-bottom: 10px; border-radius: 10px; border-color: rgba(255, 255, 255, 0.5); text-align:center; width:200px; height: 30px; margin-left: 125px; background-color: #FBAF56;">
      </div>
      <div>
        <label style="font-weight:bold;">Product length(in metre):</label>
        <input type="number" v-model="pro_size" required style="margin-bottom: 10px; border-radius: 10px; border-color: rgba(255, 255, 255, 0.5); text-align:center; width:200px; height: 30px; margin-left: 50px; background-color: #FBAF56;">
      </div>
      <div>
        <label style="font-weight:bold;">Product weight(in kg):</label>
        <input type="number" v-model="pro_wgt" required style="margin-bottom: 10px; border-radius: 10px; border-color: rgba(255, 255, 255, 0.5); text-align:center; width:200px; height: 30px; margin-left: 70px; background-color: #FBAF56;">
      </div>
      <div>
        <label style="font-weight:bold;">Product type:</label>
        <input type="text" v-model="pro_type" required style="margin-bottom: 10px; border-radius: 10px; border-color: rgba(255, 255, 255, 0.5); text-align:center; width:200px; height: 30px; margin-left: 130px; background-color: #FBAF56;">
      </div>
      <div>
        <label style="font-weight:bold;">Product specification (optional):</label>
        <input type="text" v-model="pro_anyother" style="margin-bottom: 10px; border-radius: 10px; border-color: rgba(255, 255, 255, 0.5); width:200px; text-align:center; height: 30px; margin-left: 10px; background-color: #FBAF56;">
      </div>
