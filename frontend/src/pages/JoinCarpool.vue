    ...
    <div style="padding: 20px;">
      ...
      <div class="input-box">
        <div>
          ...
          <input type="date" v-model="date" required style="text-align:center; margin-bottom: 10px; border-radius: 10px; border-color: rgba(255, 255, 255, 0.5); height: 30px; width:200px; margin-left: 80px; background-color: #FBAF56;">
        </div>
        <div>
          <label style="font-weight:bold;">Start Location:</label>
          <input type="text" v-model="startLocation" required style="text-align:center; margin-bottom: 10px; border-radius: 10px; border-color: rgba(255, 255, 255, 0.5); width:200px; height: 30px; margin-left: 12px; background-color: #FBAF56;">
        </div>
        <div>
          <label style="font-weight:bold;">End Location:</label>
          <input type="text" v-model="endLocation" required style="text-align:center; margin-bottom: 10px; border-radius: 10px; border-color: rgba(255, 255, 255, 0.5); width:200px; height: 30px; margin-left: 16px; background-color: #FBAF56;">
        </div>
